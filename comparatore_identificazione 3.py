...
class ComparatoreIdentificazioneGUI:
    ...
    def setup_ui(self):
        ...
        self.label_target_orig = tk.Label(frame_target_orig, bg='#2c3e50', width=250, height=200)
        ...
        self.label_match_orig = tk.Label(frame_match_orig, bg='#2c3e50', width=250, height=200)
        ...
        self.label_target = tk.Label(frame_target_land, bg='#2c3e50', width=250, height=200)
        ...
        self.label_match = tk.Label(frame_match_land, bg='#2c3e50', width=250, height=200)
