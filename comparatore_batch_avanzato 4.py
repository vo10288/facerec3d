...
<body>
    ...
    <script>
        ...
        function sortTable(column, direction) {{
            ...
            // Ricostruisci tabella mantenendo le righe immagini
            tbody.innerHTML = '';
            rows.forEach((row, idx) => {{
                const imgRow = row.nextElementSibling;
                const spacerRow = imgRow.nextElementSibling;
        ...
        function filterResults(type) {{
            ...
            rows.forEach(row => {{
                ...
                if (type === 'all') {{
                    ...
                    imgRow.style.display = show ? '' : 'none';
                    spacerRow.style.display = show ? '' : 'none';
                }}
            }});
            updateRowNumbers();
        }}
        ...
        function searchTable() {{
            ...
            rows.forEach(row => {{
                ...
                imgRow.style.display = match ? '' : 'none';
                spacerRow.style.display = match ? '' : 'none';
            }});
            updateRowNumbers();
        }}
